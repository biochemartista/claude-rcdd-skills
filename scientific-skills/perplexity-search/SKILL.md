...
- **sonar-pro-search** (default): Most advanced agentic search with multi-step reasoning
- **sonar-pro**: General-purpose search, best balance of cost and quality
...
- Default queries → `sonar-pro-search`
- Faster/Cheaper queries → `sonar-pro`
...
- Sonar Pro: $0.002-0.005 (faster)
- Sonar Reasoning Pro: $0.005-0.010
- Sonar Pro Search: $0.020-0.050+ (default, most comprehensive)

**Cost optimization strategies:**
1. Use `sonar` for simple fact lookups
2. Use `sonar-pro` for faster/cheaper queries
3. Default to `sonar-pro-search` for complex analysis
...
1. **Start with sonar-pro-search**: Good default for most queries
2. **Downgrade for speed/cost**: Use sonar-pro for standard queries
