...
- Good alternative for speed/cost
...
├─ YES → Use Sonar Pro Search (recommended default)
└─ NO → Continue

Is this a simple fact-finding or basic lookup?
├─ YES → Use Sonar (cost-effective)
└─ NO → Use Sonar Pro Search (safe default)
```
...
|----------|------------------|-------------|
| Literature review | Sonar Pro Search | Sonar Pro |
| Quick fact check | Sonar | Sonar Pro |
| Complex analysis | Sonar Pro Search | Sonar Reasoning Pro |
| Step-by-step tutorial | Sonar Reasoning Pro | Sonar Pro Search |
| Cost-sensitive bulk queries | Sonar | Sonar Pro |
| General research | Sonar Pro Search | Sonar Pro |
| Technical debugging | Sonar Reasoning Pro | Sonar Pro Search |
...
**Recommendation**: Start with Sonar Pro Search as the default. Downgrade to Sonar Pro for speed/cost, or Sonar for simple lookups.
...
**Default recommendation**: Start with **Sonar Pro Search** for most scientific queries.
